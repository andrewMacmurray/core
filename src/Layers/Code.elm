...
fadeIn a =
    { a
        ...
        , caption1 = delayBy 1000 hardFlicker a.caption1
        , caption2 = delayBy 1200 hardFlicker a.caption2
    }
...
code window animations =
    div
        ...
        [ Animated.div animations.code
            [ p [ class "white f2 mt0 tracked-mega" ] [ text "XVF12938179HJA" ]
            , p [ class "white f2 mt0 tracked-mega" ] [ text "OR123AKJHA1239" ]
            ]
        , Animated.div animations.caption1 [ p [ class "white f7 f5-ns tracked-mega" ] [ text "The Core released a pair of XBOXLIVE codes" ] ]
